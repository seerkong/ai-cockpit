...
import { createFetchHandler, type WorkspaceRecord, type WorkspaceRegistryLike } from '../src/app'
...
class StoreBackedRegistry implements WorkspaceRegistryLike {
  ...
  async connectLocal(directory: string): Promise<WorkspaceRecord> {
    ...
    const ws: WorkspaceRecord = {
      id: wsRow.id, token: ulid(), directory: wsRow.directory, createdAt: wsRow.createdAt, provider: createSseProvider(),
    };
